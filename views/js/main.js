...
var resizePizzas = function(size) { 
  ...
  // ALL pizzas should be the same size and change to the same size,
  // So we only need to calculate this based on the FIRST pizza!
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  var saveMovingPizzas1 = document.querySelector("#movingPizzas1");
  for (var i = 0; i < 200; i++) {
    ...
    saveMovingPizzas1.appendChild(elem);
  }
  updatePositions();
});
